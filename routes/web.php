...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::delete('/admin/delete-products/{product}', [AdminController::class, 'deleteProduct'])->name('admin-delete-products');
    ...
    Route::delete('/admin/subsubsubsubcategories/{id}', [SubSubSubSubcategoryController::class, 'destroy'])->name('subsubsubsubcategories.destroy');
