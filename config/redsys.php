...
return [
    ...
    'url_notification'      => env('REDSYS_URL_NOTIFICATION','http://127.0.0.1:8000/api/redsys/notify'),
    'url_ok'                => env('REDSYS_URL_OK','http://127.0.0.1:8000/api/redsys/ok'),
    'url_ko'                => env('REDSYS_URL_KO','http://127.0.0.1:8000/api/redsys/ko'),
